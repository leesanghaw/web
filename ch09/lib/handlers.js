...
exports.home = (req, res) => {
  ...
  if(!req.cookies.monster) {
    console.log("[DEBUG]handlers.js:home: montser cookie NOT exist")
    res.cookie('monster', 'big bear', {maxAge : 100000})
  }
  else {
    console.log("[DEBUG]handlers.js:home: montser cookie exist, "+req.cookies.monster)
    res.locals.cookieName = req.cookies.monster
    res.cookie('monster', 'big bear', {maxAge : 100000})
  }
  if(!req.signedCookies.signed_monster) {
    console.log("[DEBUG]handlers.js:home: montser_signed cookie NOT exist")
    res.cookie('signed_monster', 'big bear signed', {signed: true, maxAge: 100000})
  }
  else {
    console.log("[DEBUG]handlers.js:home: montser_signed cookie exist")
    res.cookie('signed_monster', 'big bear signed', {signed: true, maxAge: 100000})
  }
...
exports.newsletterSignupProcess = (req, res) => {
  console.log("[DEBUG]handlers.js:newletterSignupProcess: start")
  ...
  console.log("[DEBUG]handlers.js:newletterSignupProcess: name = "+name+", email = "+email)
